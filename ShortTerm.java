public class ShortTerm implements Contract {
    ...
    public ShortTerm(String contractId, double rentalAmount, String tenantId, String propertyId) {
    ...
    public Contract SignContract(String contractId, double rentalAmount, String tenantId, String propertyId) {
        Contract contract = new ShortTerm(contractId, rentalAmount, tenantId, propertyId);
        return contract;
    }

    @Override
    public String toString() {
        return "ShortTerm [ContractId=" + ContractId + ", RentalAmount=" + RentalAmount + ", TenantId=" + TenantId
                + ", PropertyId=" + PropertyId + "]";
    }
